package com.iuh.stream.imagepicker;

import static com.iuh.stream.imagepicker.ImageSelectActivity.RESULT_FILE_PATH;
...
import com.iuh.stream.imagepicker.view.ImageCropView;
...
public class ImageCropActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Cập nhật ảnh đại diện");
